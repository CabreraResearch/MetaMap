...
<button id="{id}_video_play" data-button-name="Play" class="btn btn-sm blue video-play" style="{ isPlaying ? 'display: none;' : '' }" onclick="{onClick}">Play <i class="fa fa-youtube-play"></i></button>
`
