...
"use strict";var ROUTES={MAPS_LIST:"maps/list/",MAPS_DATA:"maps/data/",MAPS_NEW_MAP:"maps/new-map/",TERMS_AND_CONDITIONS:"metamap/terms-and-conditions/",HOME:"metamap/home/",NOTIFICATIONS:"users/{0}/notifications",COURSE_LIST:"trainings/courses/"};Object.freeze(ROUTES),module.exports=ROUTES;
...
"use strict";var TAGS={META_CANVAS:"meta-canvas",HOME:"home",TERMS:"terms",MY_MAPS:"my-maps",SHARE:"share",COURSE_LIST:"course_list",TRAINING:"training"};Object.freeze(TAGS),module.exports=TAGS;
...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),riot=window.riot,NProgress=window.NProgress,pageBody=require("../tags/page-body.js"),CONSTANTS=require("../constants/constants"),Actions=require("../actions/Action.js"),Metronic=require("../template/metronic"),Layout=require("../template/layout"),Demo=require("../template/demo"),QuickSidebar=require("../template/quick-sidebar"),PageFactory=function(){function e(t,n){_classCallCheck(this,e),this.metaFire=n,this.eventer=t,this.actions=new Actions(n,t,this),this.onReady()}return _createClass(e,[{key:"onReady",value:function(){return this._onReady||(this._onReady=new Promise(function(e,t){$("#"+CONSTANTS.ELEMENTS.META_PROGRESS).remove(),riot.mount("*"),NProgress.configure({parent:"#"+CONSTANTS.ELEMENTS.META_PROGRESS_NEXT}),_.delay(function(){Metronic.init(),Layout.init(),Demo.init(),QuickSidebar.init(),e()},250)})),this._onReady}},{key:"navigate",value:function(e,t,n){for(var r,i=arguments.length,a=Array(i>3?i-3:0),o=3;i>o;o++)a[o-3]=arguments[o];var s=(r=this.actions).act.apply(r,[e,t,n].concat(a));if(!s){var c;(c=this.eventer)["do"].apply(c,[e,e,{id:t,action:n}].concat(a))}}}]),e}();module.exports=PageFactory;
...
"use strict";var riot=require("riot"),moment=require("moment"),Ps=require("perfect-scrollbar"),raw=require("./raw"),CONSTANTS=require("../../constants/constants"),html='\n<div class="page-quick-sidebar-wrapper">\n    <div class="page-quick-sidebar">\n        <div class="nav-justified">\n            <ul class="nav nav-tabs nav-justified">\n                <li class="active">\n                    <a href="#quick_sidebar_tab_1" data-toggle="tab">\n                    Cortex Man\n                    </a>\n                </li>\n                <li>\n                    <a href="#quick_sidebar_tab_2" data-toggle="tab">\n                    Outline\n                    </a>\n                </li>\n            </ul>\n            <div class="tab-content">\n                <div class="tab-pane active page-quick-sidebar-chat page-quick-sidebar-content-item-shown" id="quick_sidebar_tab_1">\n                    <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">\n                    </div>\n                    <div class="page-quick-sidebar-item">\n                        <div class="page-quick-sidebar-chat-user">\n                            <div class="page-quick-sidebar-chat-user-messages">\n                                <div each="{ messages }" class="post { out: author == \'cortex\', in: author != \'cortex\' }">\n                                    <img height="39" width="39" class="avatar" alt="" src="{ picture }"/>\n                                    <div class="message">\n                                        <span class="arrow"></span>\n                                        <a href="javascript:;" class="name">{ name }</a>\n                                        <span class="datetime">{ parent.getRelativeTime(time) }</span>\n                                        <span class="body">\n                                        <raw content="{ message }"></raw> </span>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class="page-quick-sidebar-chat-user-form">\n                                <form id="chat_input_form" onsubmit="{ onSubmit }">\n                                    <div class="input-group">\n                                        <input id="chat_input" type="text" class="form-control" placeholder="Type a message here...">\n                                        <div class="input-group-btn">\n                                            <button type="submit" class="btn blue"><i class="fa fa-paperclip"></i></button>\n                                        </div>\n                                    </div>\n                                </form>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                <div class="tab-pane page-quick-sidebar-alerts" id="quick_sidebar_tab_2">\n                    <div class="page-quick-sidebar-alerts-list">\n                        <h3 class="list-heading">Intro</h3>\n                        <h3 class="list-heading">Section 1</h3>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n';riot.tag("quick-sidebar",html,function(a){var e=this;this.cortexPicture="src/images/cortex-avatar-small.jpg",this.messages=[{message:"Hello, I'm Cortex Man. Ask me anything. Try <code>/help</code> if you get lost.",author:"cortex",picture:this.cortexPicture,time:new Date}];var t=require("../../../MetaMap");this.on("update",function(){}),this.on("mount",function(){e.update()}),this.getDisplay=function(){return e.display?"":"display: none;"},this.getRelativeTime=function(){var a=arguments.length<=0||void 0===arguments[0]?new Date:arguments[0];return moment(a).fromNow()},this.onSubmit=function(a){e.messages.push({message:e.chat_input.value,author:t.User.userName,picture:t.User.picture,time:new Date}),e.messages.push({message:"You asked me "+e.chat_input.value+". That's great!",author:"cortex",picture:e.cortexPicture,time:new Date}),e.chat_input.value="",e.update(),e.chat_body.scrollTop=e.chat_body.scrollHeight,Ps.update(e.chat_body)},this.toggle=function(a){e.display=a,e.update()}});
...
"use strict";var riot=require("riot"),pageSidebar=require("./page-sidebar"),pageContent=require("./page-content"),html='\n<div class="page-container">\n\n    <div id="meta_page_content"></div>\n</div>\n';module.exports=riot.tag("page-container",html,function(e){var t=this;require("../../MetaMap");this.on("mount",function(){riot.mount(t.meta_page_content,"page-content")})});
},{"../../MetaMap":1,"./page-content":58,"./page-sidebar":63,"riot":"riot"}],58:[function(require,module,exports){
"use strict";var riot=require("riot"),CONSTANTS=require("../constants/constants"),_=require("lodash");require("./components/quick-sidebar");var html='\n<div class="page-content-wrapper">\n    <div id="page-content" class="page-content">\n\n        <div class="page-head"></div>\n\n        <div id="app-container"></div>\n\n        <div id="quick_sidebar_container"></div>\n    </div>\n</div>\n';module.exports=riot.tag("page-content",html,function(i){var n=this;require("../../MetaMap");this.on("mount",function(){riot.mount(n.quick_sidebar_container,"quick-sidebar"),n.resize()}),this.resize=function(){var i=window.innerWidth-40+"px";$(n["app-container"]).css({width:i})},$(window).on("resize",function(){n.resize()})});
...
"use strict";var riot=require("riot"),NProgress=window.NProgress,_=require("lodash"),$=require("jquery");require("datatables"),require("datatables-bootstrap3-plugin");var CONSTANTS=require("../../constants/constants"),raw=require("../components/raw"),moment=require("moment"),html='\n<div id="trainings_page" class="portlet box grey-cascade">\n    <div class="portlet-title">\n        <div class="caption">\n            <i class="fa fa-icon-th-large"></i>Courses\n        </div>\n    </div>\n    <div class="portlet-body">\n        <div class="tab-content">\n            <div>\n                <table class="table table-striped table-bordered table-hover" id="training_table">\n                    <thead>\n                        <tr>\n                            <th>\n                                Name\n                            </th>\n                            <th>\n                                Created On\n                            </th>\n                        </tr>\n                    </thead>\n                    <tbody>\n                        <tr if="{ data }" each="{ data }" class="odd gradeX">\n                            <td style="vertical-align: middle;"><a href="#trainings/{id}">{ name }</a></td>\n                            <td style="vertical-align: middle;">{ created_at }</td>\n                        </tr>\n                    </tbody>\n                </table>\n            </div>\n        </div>\n    </div>\n</div>\n';module.exports=riot.tag(CONSTANTS.PAGES.COURSE_LIST,html,function(t){var a=this,e=require("../../../MetaMap.js");this.user=e.User,this.data=null,this.on("update",function(){}),this.on("mount",function(){NProgress.start();var t=function(t){try{a.data=t,a.table&&a.dataTable.destroy(),a.update(),a.table=$(a.training_table),a.dataTable=a.table.DataTable({columns:[{name:"Name",orderable:!0},{name:"Created On",orderable:!0}]});var n=a.table.parent().parent().parent().find("#training_table_wrapper");n.find(".dataTables_length select").addClass("form-control input-xsmall input-inline")}catch(r){e.error(r)}finally{NProgress.done()}};e.MetaFire.getChild(CONSTANTS.ROUTES.COURSE_LIST).on("value",function(a){var e=a.val(),n=_.map(e,function(t,a){return t.editable=!0,t.id=a,t.created_at=moment(new Date(t.created_at)).format("YYYY-MM-DD"),t});t(n),$(".owner-label").tooltip()})})});
...
"use strict";var riot=require("riot"),NProgress=window.NProgress,CONSTANTS=require("../../constants/constants"),VideoPlayer=require("../../tools/VideoPlayer"),html='\n<div id="training_portlet" class="portlet light">\n				<div class="portlet-body">\n					<div class="row margin-bottom-30">\n                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">\n\n				        </div>\n                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">\n                            <div id="training_player"></div>\n				        </div>\n					</div>\n				</div>\n			</div>\n';module.exports=riot.tag(CONSTANTS.TAGS.TRAINING,html,function(i){var t=this,n=require("../../../MetaMap.js");this.training={};var o=_.once(function(){t.config.id&&n.MetaFire.on(""+CONSTANTS.ROUTES.COURSE_LIST+t.config.id,function(i){t.training=i,n.Eventer["do"](CONSTANTS.EVENTS.PAGE_NAME,i),t.update(),NProgress.done()})});this.on("mount update",function(i,n){n&&(t.config=n,o(),t.player=new VideoPlayer("training_player",{height:390,width:640,videoId:"dUqRTWCdXt4"}))}),this.correctHeight=function(){$(t.training_portlet).css({height:window.innerHeight-120+"px"})},this.on("update",function(){t.correctHeight()}),$(window).resize(function(){t.correctHeight()})});
...
"use strict";var $=require("jquery"),Metronic=require("./metronic"),QuickSidebar=function(){var i=function(){$(".page-header .quick-sidebar-toggler, .page-quick-sidebar-toggler").click(function(i){$("body").toggleClass("page-quick-sidebar-open")})},e=function(){var i=$(".page-quick-sidebar-wrapper"),e=i.find(".page-quick-sidebar-chat"),a=function(){var a,r=i.find(".page-quick-sidebar-chat-users");a=i.height()-i.find(".nav-justified > .nav-tabs").outerHeight(),Metronic.destroySlimScroll(r),r.attr("data-height",a),Metronic.initSlimScroll(r);var t=e.find(".page-quick-sidebar-chat-user-messages"),c=a-e.find(".page-quick-sidebar-chat-user-form").outerHeight()-e.find(".page-quick-sidebar-nav").outerHeight();Metronic.destroySlimScroll(t),t.attr("data-height",c),Metronic.initSlimScroll(t)};a(),Metronic.addResizeHandler(a),i.find(".page-quick-sidebar-chat-users .media-list > .media").click(function(){e.addClass("page-quick-sidebar-content-item-shown")}),i.find(".page-quick-sidebar-chat-user .page-quick-sidebar-back-to-list").click(function(){e.removeClass("page-quick-sidebar-content-item-shown")})},a=function(){var i=$(".page-quick-sidebar-wrapper"),e=(i.find(".page-quick-sidebar-alerts"),function(){var e,a=i.find(".page-quick-sidebar-alerts-list");e=i.height()-i.find(".nav-justified > .nav-tabs").outerHeight(),Metronic.destroySlimScroll(a),a.attr("data-height",e),Metronic.initSlimScroll(a)});e(),Metronic.addResizeHandler(e)};return{init:function(){i(),e(),a()}}}();module.exports=QuickSidebar;
...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),Promise=require("bluebird"),VideoPlayer=function(){function e(t){var n=arguments.length<=1||void 0===arguments[1]?{height:390,width:640,videoId:""}:arguments[1];_classCallCheck(this,e),this.id=t,this.opts=n,this.metaMap=require("../../MetaMap"),this.init()}return _createClass(e,[{key:"onReady",value:function(){var e=this;return this._onReady=this._onReady||new Promise(function(t,n){var i=function a(){window.YT&&1==window.YT.loaded?(e.YT=window.YT,t(window.YT)):setTimeout(a,250)};i()}),this._onReady}},{key:"init",value:function(){var e=this;this.onReady().then(function(){e.player=new e.YT.Player(e.id,{height:e.opts.height,width:e.opts.width,videoId:e.opts.videoId,events:{onReady:e.onPlayerReady,onStateChange:e.onPlayerStateChange}})})}},{key:"onPlayerReady",value:function(e){e.target.playVideo()}},{key:"onPlayerStateChange",value:function(e){e.data==YouTube.integration.PlayerState.ENDED&&(this.done=!0)}},{key:"stopVideo",value:function(){this.player.stopVideo()}},{key:"isDone",get:function(){return 1==this.done}}]),e}();module.exports=VideoPlayer;
