...
"use strict";var riot=require("riot"),moment=require("moment"),Metronic=require("../../template/metronic"),raw=require("./raw"),CONSTANTS=require("../../constants/constants"),TrainingMix=require("../mixins/training-mix"),html='\n<div class="page-quick-sidebar-wrapper">\n    <div class="page-quick-sidebar">\n        <div class="nav-justified">\n            <ul class="nav nav-tabs nav-justified">\n                <li class="active">\n                    <a href="#quick_sidebar_tab_1" data-toggle="tab">\n                    Cortex Man\n                    </a>\n                </li>\n                <li>\n                    <a href="#quick_sidebar_tab_2" data-toggle="tab">\n                    Outline\n                    </a>\n                </li>\n            </ul>\n            <div class="tab-content">\n                <div class="tab-pane active page-quick-sidebar-chat page-quick-sidebar-content-item-shown" id="quick_sidebar_tab_1">\n                    <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">\n                    </div>\n                    <div class="page-quick-sidebar-item">\n                        <div class="page-quick-sidebar-chat-user">\n                            <div id="cortex_messages" class="page-quick-sidebar-chat-user-messages">\n                                <div each="{ userTraining.messages }" class="post { out: author == \'cortex\', in: author != \'cortex\' }">\n                                    <img height="39" width="39" class="avatar" alt="" src="{ author == \'cortex\' ? parent.cortexPicture : parent.userPicture }"/>\n                                    <div class="message">\n                                        <span class="arrow"></span>\n                                        <a href="javascript:;" class="name">{ name }</a>\n                                        <span class="datetime">{ parent.getRelativeTime(time) }</span>\n                                        <span class="body">\n                                        <raw content="{ message }"></raw> </span>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class="page-quick-sidebar-chat-user-form">\n                                <form id="chat_input_form" onsubmit="{ onSubmit }">\n                                    <div class="input-group">\n                                        <input id="chat_input" type="text" class="form-control" placeholder="Type a message here...">\n                                        <div class="input-group-btn">\n                                            <button type="submit" class="btn blue"><i class="fa fa-paperclip"></i></button>\n                                        </div>\n                                    </div>\n                                </form>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                <div class="tab-pane page-quick-sidebar-alerts" id="quick_sidebar_tab_2">\n                    <div class="page-quick-sidebar-alerts-list">\n                        <h3 class="list-heading">Intro</h3>\n                        <h3 class="list-heading">Section 1</h3>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n',handleQuickSidebarToggler=function(){$(".page-header .quick-sidebar-toggler, .page-quick-sidebar-toggler").click(function(i){$("body").toggleClass("page-quick-sidebar-open")})},handleQuickSidebarChat=function(){var i=$(".page-quick-sidebar-wrapper"),e=i.find(".page-quick-sidebar-chat"),a=function(){var a,t=i.find(".page-quick-sidebar-chat-users");a=i.height()-i.find(".nav-justified > .nav-tabs").outerHeight(),Metronic.destroySlimScroll(t),t.attr("data-height",a),Metronic.initSlimScroll(t);var n=e.find(".page-quick-sidebar-chat-user-messages"),s=a-e.find(".page-quick-sidebar-chat-user-form").outerHeight()-e.find(".page-quick-sidebar-nav").outerHeight();Metronic.destroySlimScroll(n),n.attr("data-height",s),Metronic.initSlimScroll(n)};a(),Metronic.addResizeHandler(a),i.find(".page-quick-sidebar-chat-users .media-list > .media").click(function(){e.addClass("page-quick-sidebar-content-item-shown")}),i.find(".page-quick-sidebar-chat-user .page-quick-sidebar-back-to-list").click(function(){e.removeClass("page-quick-sidebar-content-item-shown")})},handleQuickSidebarAlerts=function(){var i=$(".page-quick-sidebar-wrapper"),e=(i.find(".page-quick-sidebar-alerts"),function(){var e,a=i.find(".page-quick-sidebar-alerts-list");e=i.height()-i.find(".nav-justified > .nav-tabs").outerHeight(),Metronic.destroySlimScroll(a),a.attr("data-height",e),Metronic.initSlimScroll(a)});e(),Metronic.addResizeHandler(e)};riot.tag(CONSTANTS.TAGS.SIDEBAR,html,function(i){var e=this;this.mixin(TrainingMix);var a=require("../../../MetaMap");this.userPicture="",this.on("update",function(){handleQuickSidebarToggler(),handleQuickSidebarChat(),handleQuickSidebarAlerts(),e.userPicture=a.User.picture,$(e.cortex_messages).slimScroll({scrollBy:"100px"})}),this.getDisplay=function(){return e.display?"":"display: none;"},this.getRelativeTime=function(){var i=arguments.length<=0||void 0===arguments[0]?new Date:arguments[0];return moment(i).fromNow()},this.onSubmit=function(i){e.userTraining.messages.push({message:e.chat_input.value,time:new Date}),e.saveUserTraining(e.trainingId),e.chat_input.value="",e.update()},a.Eventer.on(CONSTANTS.EVENTS.SIDEBAR_CLOSE,function(){$("body").removeClass("page-quick-sidebar-open")}),a.Eventer.on(CONSTANTS.EVENTS.SIDEBAR_OPEN,function(i){e.trainingId=i,e.getData(i),$("body").addClass("page-quick-sidebar-open")})});
...
"use strict";var CONSTANTS=require("../../constants/constants"),NProgress=window.NProgress,moment=require("moment"),TrainingMix={init:function(){this.MetaMap=require("../../../MetaMap.js")},userTraining:{messages:[]},training:{},getDate:function(e){return moment(new Date(e)).format("YYYY-MM-DD")},saveUserTraining:function(e){this.MetaMap.MetaFire.setData(this.userTraining,""+CONSTANTS.ROUTES.TRAININGS.format(this.MetaMap.User.userId)+e)},saveTraining:function(e,a){this.MetaMap.MetaFire.updateData({course:a,updated_date:""+new Date,updated_by:{user_id:this.MetaMap.User.userId,name:this.MetaMap.User.displayName,picture:this.MetaMap.User.picture}},""+CONSTANTS.ROUTES.COURSE_LIST+e)},getData:function(e){var a=this;e&&!function(){var t=a;a._onceGetData=a._onceGetData||_.once(function(){var a=_.once(function(){t.MetaMap.MetaFire.on(""+CONSTANTS.ROUTES.TRAININGS.format(t.MetaMap.User.userId)+e,function(a){t.userTraining=a,a||(t.userTraining=t.training,t.saveUserTraining(e)),t.userTraining.messages||(t.userTraining.messages=[t.getDefaultMessage()],t.saveUserTraining(e)),t.update(),NProgress.done()}),t.MetaMap.Eventer["do"](CONSTANTS.EVENTS.SIDEBAR_OPEN,e)});t.MetaMap.MetaFire.on(""+CONSTANTS.ROUTES.COURSE_LIST+e,function(e){t.training=e,t.MetaMap.Eventer["do"](CONSTANTS.EVENTS.PAGE_NAME,e),t.update(),a()})}),a._onceGetData()}()},messages:[],cortexPicture:"src/images/cortex-avatar-small.jpg",getDefaultMessage:function(){return{message:"Hello, I'm Cortex Man. Ask me anything. Try <code>/help</code> if you get lost.",author:"cortex",time:new Date}}};module.exports=TrainingMix;
...
"use strict";var riot=require("riot"),NProgress=window.NProgress,CONSTANTS=require("../../constants/constants"),VideoPlayer=require("../../tools/VideoPlayer"),TrainingMix=require("../mixins/training-mix"),html='\n<div id="training_portlet" class="portlet light">\n    <div class="portlet-body">\n        <div class="row margin-bottom-30">\n            <div class="col-md-8 col-md-offset-4">\n                <div class="embed-responsive embed-responsive-16by9">\n                    <div id="training_player" ></div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n';module.exports=riot.tag(CONSTANTS.TAGS.TRAINING,html,function(i){var n=this;this.mixin(TrainingMix),this.training={},this.on("mount update",function(i,t){t&&(n.config=t,n.getData(n.config.id))}),this.correctHeight=function(){$(n.training_portlet).css({height:window.innerHeight-120+"px"})},this.on("update",function(){n.correctHeight()}),$(window).resize(function(){n.correctHeight()})});
},{"../../constants/constants":29,"../../tools/VideoPlayer":76,"../mixins/training-mix":55,"riot":"riot"}],70:[function(require,module,exports){
"use strict";var riot=require("riot"),NProgress=window.NProgress,_=require("lodash"),$=require("jquery"),Dropzone=require("dropzone"),Papa=require("papaparse");require("datatables"),require("datatables-bootstrap3-plugin");var CONSTANTS=require("../../constants/constants"),raw=require("../components/raw"),TrainingMix=require("../mixins/training-mix"),html='\n<table class="table table-striped table-bordered table-hover" id="{tableId}">\n    <thead>\n        <tr>\n            <th each="{columns}">{name}</th>\n        </tr>\n    </thead>\n    <tbody>\n        <tr if="{ data }" each="{ data }" class="odd gradeX">\n            <td style="vertical-align: middle;">\n                <a class="btn btn-sm red" onclick="{ parent.onStart }">Start <i class="fa fa-play"></i></a>\n                <a if="{ parent.user.isAdmin }" class="btn btn-sm blue" onclick="{ parent.onDownload }">Save <i class="fa fa-cloud-download"></i></a>\n            </td>\n            <td class="{ meta_editable: parent.editable}" data-pk="{ id }" data-name="name" data-title="Edit Course Name" style="vertical-align: middle;">\n                { name }\n            </td>\n            <td class="{ meta_editable: parent.editable}" data-pk="{ id }" data-name="description" data-title="Edit Course Description" style="vertical-align: middle;">\n                { description }\n            </td>\n            <td style="vertical-align: middle;">\n                { course ? course.length : 0 } Steps\n            </td>\n            <td if="{ parent.user.isAdmin }" style="vertical-align: middle;">\n                { parent.getDate(updated_date) }\n            </td>\n            <td if="{ parent.user.isAdmin }" style="vertical-align: middle;">\n                <span class="label owner-label" data-toggle="tooltip" data-placement="bottom" title="{ updated_by.name }">\n                    <img alt="{ updated_by.name }" height="30" width="30" class="img-circle" src="{ updated_by.picture }" />\n                </span>\n            </td>\n            <td if="{ parent.user.isAdmin }" >\n                <form  method="{ parent.onUpload }" url="/noupload" class="dropzone" id="training_upload_{ id }"></form>\n            </td>\n        </tr>\n    </tbody>\n</table>\n';module.exports=riot.tag(CONSTANTS.TAGS.ALL_COURSES,html,function(e){var a=this;this.mixin(TrainingMix);var t=require("../../../MetaMap.js");this.user=t.User,this.data=[],this.editable=!1,this.tableId="all_courses",this.dropzones={},this.columns=[{name:"Action",orderable:!1,width:"120px"},{name:"Name",orderable:!0},{name:"Description",orderable:!0},{name:"Length",orderable:!0}],this.user.isAdmin&&(this.columns.push({name:"Last Updated",orderable:!0}),this.columns.push({name:"Last Updated By",orderable:!0}),this.columns.push({name:"Upload Training",orderable:!1})),this.onStart=function(e){t.Router.to("trainings/"+e.item.id)},this.onDownload=function(e){var t=e.item.id;if(t&&a._data[t]){var n="data:text/csv;charset=utf-8,"+Papa.unparse(a._data[t].course),i=encodeURI(n),d=document.createElement("a");d.setAttribute("href",i),d.setAttribute("download",a._data[t].name+".csv"),d.click()}},this.initDropzone=function(e){try{!function(){var t=a;t.dropzones[e]=t.dropzones[e]||new Dropzone("#training_upload_"+e,{url:"/noup",paramName:"file",maxFiles:0,addRemoveLinks:!0,autoProcessQueue:!1,dictMaxFilesExceeded:"One training at a time!",acceptedFiles:".csv",init:function(){var a=this;a.on("drop",function(e){if(a.files.length>0||!e.dataTransfer.files[0].name.endsWith(".csv"))throw new Error("Only 1 CSV file at a time.")}),a.on("addedfile",function(n){Papa.parse(n,{header:!0,complete:function(n,i){t.saveTraining(e,n.data),a.removeAllFiles(!0)}})})}})}()}catch(t){console.log(t)}},this.buildTable=function(){try{a.table&&(a.table.find(".meta_editable").editable("destroy"),a.dataTable.destroy()),a.table=$(document.getElementById([a.tableId])),a.dataTable=a.table.DataTable({columns:a.columns});var e=a.table.parent().parent().parent().find("#"+a.tableId+"_table_wrapper");e.find(".dataTables_length select").addClass("form-control input-xsmall input-inline"),a.table.find(".meta_editable").editable({unsavedclass:null}).on("save",function(e,a){if(this.dataset&&this.dataset.pk){var n=this.dataset.pk;t.MetaFire.setData(a.newValue,CONSTANTS.ROUTES.COURSE_LIST+"/"+n+"/"+this.dataset.name)}return!0})}catch(n){}finally{NProgress.done()}},this.on("mount",function(){a.editable=a.user.isAdmin});var n=_.once(function(){t.MetaFire.on(CONSTANTS.ROUTES.COURSE_LIST,function(e){a._data=e,a.data=_.map(a._data,function(e,t){return e.id=t,e.created_at=a.getDate(e.created_at),e}),a.data&&(a.update(),a.buildTable(0,a.data),_.each(a.data,function(e){a.initDropzone(e.id)}))})});this.on("update",function(){n()})});
