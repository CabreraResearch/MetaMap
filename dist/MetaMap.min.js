...
"use strict";var riot=require("riot"),NProgress=window.NProgress,CONSTANTS=require("../../constants/constants"),VideoPlayer=require("../../tools/VideoPlayer"),html='\n<div id="training_portlet" class="portlet light">\n    <div class="portlet-body">\n        <div class="row margin-bottom-30">\n            <div class="col-md-8 col-md-offset-4">\n                <div class="embed-responsive embed-responsive-16by9">\n                    <div id="training_player" ></div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n';module.exports=riot.tag(CONSTANTS.TAGS.TRAINING,html,function(i){var n=this,e=require("../../../MetaMap.js");this.training={};var t=function(){e.MetaFire.setData(n.userTraining,""+CONSTANTS.ROUTES.TRAININGS.format(e.User.userId)+n.config.id)},r=_.once(function(){if(n.config.id){var i=_.once(function(){e.MetaFire.on(""+CONSTANTS.ROUTES.TRAININGS.format(e.User.userId)+n.config.id,function(i){n.userTraining=i,i||(n.userTraining=n.training,t()),n.update(),NProgress.done()}),e.Eventer["do"](CONSTANTS.EVENTS.SIDEBAR_OPEN)});e.MetaFire.on(""+CONSTANTS.ROUTES.COURSE_LIST+n.config.id,function(t){n.training=t,e.Eventer["do"](CONSTANTS.EVENTS.PAGE_NAME,t),n.update(),i()})}});this.on("mount update",function(i,e){e&&(n.config=e,r(),n.player=new VideoPlayer("training_player",{height:390,width:640,videoId:"dUqRTWCdXt4"}))}),this.correctHeight=function(){$(n.training_portlet).css({height:window.innerHeight-120+"px"})},this.on("update",function(){n.correctHeight()}),$(window).resize(function(){n.correctHeight()})});
