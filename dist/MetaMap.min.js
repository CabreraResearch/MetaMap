...
"use strict";var riot=require("riot"),NProgress=window.NProgress,_=require("lodash"),$=require("jquery");require("datatables"),require("datatables-bootstrap3-plugin");var CONSTANTS=require("../../constants/constants"),raw=require("../components/raw"),moment=require("moment"),html='\n<div id="trainings_page" class="portlet box grey-cascade">\n    <div class="portlet-title">\n        <div class="caption">\n            <i class="fa fa-icon-th-large"></i>Courses\n        </div>\n    </div>\n    <div class="portlet-body">\n        <div class="tab-content">\n            <div>\n                <table class="table table-striped table-bordered table-hover" id="training_table">\n                    <thead>\n                        <tr>\n                            <th>Name</th>\n                            <th>Description</th>\n                        </tr>\n                    </thead>\n                    <tbody>\n                        <tr if="{ data }" each="{ data }" class="odd gradeX">\n                            <td style="vertical-align: middle;"><a href="#trainings/{id}">{ name }</a></td>\n                            <td style="vertical-align: middle;">{ description }</td>\n                        </tr>\n                    </tbody>\n                </table>\n            </div>\n        </div>\n    </div>\n</div>\n';module.exports=riot.tag(CONSTANTS.PAGES.COURSE_LIST,html,function(t){var e=this,a=require("../../../MetaMap.js");this.user=a.User,this.data=null,this.on("update",function(){}),this.on("mount",function(){NProgress.start();var t=function(t){try{e.data=t,e.table&&e.dataTable.destroy(),e.update(),e.table=$(e.training_table),e.dataTable=e.table.DataTable({columns:[{name:"Name",orderable:!0},{name:"Created On",orderable:!0}]});var n=e.table.parent().parent().parent().find("#training_table_wrapper");n.find(".dataTables_length select").addClass("form-control input-xsmall input-inline")}catch(r){a.error(r)}finally{NProgress.done()}};a.MetaFire.getChild(CONSTANTS.ROUTES.COURSE_LIST).on("value",function(e){var a=e.val(),n=_.map(a,function(t,e){return t.editable=!0,t.id=e,t.created_at=moment(new Date(t.created_at)).format("YYYY-MM-DD"),t});t(n),$(".owner-label").tooltip()})})});
