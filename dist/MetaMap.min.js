...
"use strict";var riot=require("riot"),NProgress=window.NProgress,CONSTANTS=require("../../constants/constants"),VideoPlayer=require("../../tools/VideoPlayer"),html='\n<div id="training_portlet" class="portlet light">\n    <div class="portlet-body">\n        <div class="row margin-bottom-30">\n            <div class="col-md-6 col-md-offset-6">\n                <div id="training_player"></div>\n            </div>\n        </div>\n    </div>\n</div>\n';module.exports=riot.tag(CONSTANTS.TAGS.TRAINING,html,function(i){var n=this,t=require("../../../MetaMap.js");this.training={};var e=function(){t.MetaFire.setData(n.userTraining,""+CONSTANTS.ROUTES.TRAININGS.format(t.User.userId)+n.config.id)},r=_.once(function(){if(n.config.id){var i=_.once(function(){t.MetaFire.on(""+CONSTANTS.ROUTES.TRAININGS.format(t.User.userId)+n.config.id,function(i){n.userTraining=i,i||(n.userTraining=n.training,e()),n.update(),NProgress.done()}),t.Eventer["do"](CONSTANTS.EVENTS.SIDEBAR_OPEN)});t.MetaFire.on(""+CONSTANTS.ROUTES.COURSE_LIST+n.config.id,function(e){n.training=e,t.Eventer["do"](CONSTANTS.EVENTS.PAGE_NAME,e),n.update(),i()})}});this.on("mount update",function(i,t){t&&(n.config=t,r(),n.player=new VideoPlayer("training_player",{height:390,width:640,videoId:"dUqRTWCdXt4"}))}),this.correctHeight=function(){$(n.training_portlet).css({height:window.innerHeight-120+"px"})},this.on("update",function(){n.correctHeight()}),$(window).resize(function(){n.correctHeight()})});
...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,n,a){return n&&e(t.prototype,n),a&&e(t,a),t}}(),Promise=require("bluebird"),VideoPlayer=function(){function e(t){var n=arguments.length<=1||void 0===arguments[1]?{height:390,width:640,videoId:""}:arguments[1];_classCallCheck(this,e),this.id=t,this.opts=n,this.metaMap=require("../../MetaMap"),this.init()}return _createClass(e,[{key:"onReady",value:function(){var e=this;return this._onReady=this._onReady||new Promise(function(t,n){var a=function i(){window.YT&&1==window.YT.loaded?(e.YT=window.YT,t(window.YT)):setTimeout(i,250)};a()}),this._onReady}},{key:"init",value:function(){var e=this;this.onReady().then(function(){e.player=new e.YT.Player(e.id,{height:e.opts.height,width:e.opts.width,videoId:e.opts.videoId,events:{onReady:e.onPlayerReady,onStateChange:e.onPlayerStateChange}})})}},{key:"onPlayerReady",value:function(e){e.target.playVideo()}},{key:"onPlayerStateChange",value:function(e){e.data==YT.PlayerState.ENDED&&(this.done=!0)}},{key:"stopVideo",value:function(){this.player.stopVideo()}},{key:"isDone",get:function(){return 1==this.done}}]),e}();module.exports=VideoPlayer;
