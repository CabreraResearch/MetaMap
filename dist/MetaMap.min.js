...
"use strict";var TAGS={META_CANVAS:"meta-canvas",HOME:"home",TERMS:"terms",MY_MAPS:"my-maps",SHARE:"share",COURSE_LIST:"course_list",TRAINING:"training",ALL_COURSES:"all-courses",MY_COURSES:"my-courses"};Object.freeze(TAGS),module.exports=TAGS;
...
"use strict";var riot=require("riot"),pageSidebar=require("./page-sidebar"),pageContent=require("./page-content"),html='\n<div class="page-container">\n\n    <div id="meta_page_content"></div>\n</div>\n';module.exports=riot.tag("page-container",html,function(e){var t=this;require("../../MetaMap");this.on("update",function(){riot.mount(t.meta_page_content,"page-content")})});
},{"../../MetaMap":1,"./page-content":58,"./page-sidebar":63,"riot":"riot"}],58:[function(require,module,exports){
"use strict";var riot=require("riot"),CONSTANTS=require("../constants/constants"),_=require("lodash");require("./components/quick-sidebar");var html='\n<div class="page-content-wrapper">\n    <div id="page-content" class="page-content">\n\n        <div class="page-head"></div>\n\n        <div id="app-container"></div>\n\n        <div id="quick_sidebar_container"></div>\n    </div>\n</div>\n';module.exports=riot.tag("page-content",html,function(i){var n=this;require("../../MetaMap");this.on("update",function(){riot.mount(n.quick_sidebar_container,"quick-sidebar"),n.resize()}),this.resize=function(){var i=window.innerWidth-40+"px";$(n["app-container"]).css({width:i})},$(window).on("resize",function(){n.resize()})});
