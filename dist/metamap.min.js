...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var s=t[a];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,a,s){return a&&e(t.prototype,a),s&&e(t,s),t}}(),Permissions=function(){function e(t){_classCallCheck(this,e),this.map=t,this.metaMap=require("../../MetaMap")}return _createClass(e,[{key:"canEdit",value:function(){return this.isMapOwner()||this.isSharedEdit()}},{key:"isMapOwner",value:function(){return this.map&&this.map.owner.userId==this.metaMap.User.userId}},{key:"isSharedEdit",value:function(){return this.map&&this.map.shared_with&&(this.metaMap.User.isAdmin||this.map.shared_with[this.metaMap.User.userId]&&1==this.map.shared_with[this.metaMap.User.userId].write||this.map.shared_with["*"]&&1==this.map.shared_with["*"].write)}}]),e}();module.exports=Permissions;
