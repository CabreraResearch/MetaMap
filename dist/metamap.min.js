...
"use strict";var ACTIONS=require("./actions.js"),_=require("lodash"),PAGES={MAP:"map",NEW_MAP:"new_map",COPY_MAP:"copy_map",DELETE_MAP:"delete_map",MY_MAPS:"mymaps",TERMS_AND_CONDITIONS:"terms",HOME:"home",COURSE_LIST:"course_list",TRAINING:"training"};_.extend(),Object.freeze(PAGES),module.exports=PAGES;
...
"use strict";var TAGS={META_CANVAS:"meta-canvas",HOME:"home",TERMS:"terms",MY_MAPS:"my-maps",SHARE:"share",COURSE_LIST:"course_list"};Object.freeze(TAGS),module.exports=TAGS;
...
},{"./_IntegrationsBase":47,"dup":41}],49:[function(require,module,exports){
...
"use strict";var riot=require("riot"),pageHeader=require("./page-header"),pageContainer=require("./page-container"),pageFooter=require("./page-footer"),CONSTANTS=require("../constants/constants"),html='\n<div id="page_body" class="page-header-fixed page-sidebar-reversed">\n\n    <div id="meta_page_header"></div>\n\n    <div class="clearfix">\n    </div>\n\n    <div id="meta_page_container"></div>\n\n</div>';module.exports=riot.tag("page-body",html,function(e){var a=this,n=require("../../MetaMap");this.on("mount",function(){riot.mount(a.meta_page_header,"page-header"),riot.mount(a.meta_page_container,"page-container")}),n.Eventer.on(CONSTANTS.EVENTS.SIDEBAR_CLOSE,function(){}),n.Eventer.on(CONSTANTS.EVENTS.SIDEBAR_OPEN,function(){})});
...
"use strict";var riot=require("riot"),NProgress=window.NProgress,CONSTANTS=require("../../constants/constants"),html='\n<div class="portlet light">\n				<div class="portlet-body">\n					<div class="row margin-bottom-30">\n						<div if="{ training }" class="col-md-12">\n                            <h1>{ training.name }</h1>\n                            <p>{ training.text }</p>\n						</div>\n					</div>\n				</div>\n			</div>\n';module.exports=riot.tag(CONSTANTS.PAGES.TRAINING,html,function(n){var i=this,t=require("../../../MetaMap.js");this.training={};var o=_.once(function(){i.config.id&&t.MetaFire.on(""+CONSTANTS.ROUTES.COURSE_LIST+i.config.id,function(n){i.training=n,t.Eventer["do"](CONSTANTS.EVENTS.PAGE_NAME,n),i.update(),NProgress.done()})});this.on("mount update",function(n,t){t&&(i.config=t,o())})});
