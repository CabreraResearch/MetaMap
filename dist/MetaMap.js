...
riot.tag('chat', html, function (opts) {
    ...
    this.correctHeight = function () {
        _this.chat_shell.style.height = window.innerHeight - 154 + 'px';
        _this.chat_body.style.height = window.innerHeight - 301 + 'px';
